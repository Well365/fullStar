...
| `game-qa-autopilot/.env` | Jira 凭证 |
| `game-qa-autopilot/autoqa.config.local.ts` | 本机 URL、账号密码 |
...
原 `tg-notify/`、`tg-notify-skill/`、`WebDriverAgent/`、`game-qa-autopilot/` 曾各有独立 `.git`，  
